...
<form class="max-w-lg mx-auto border p-6 mt-4 shadow-lg flex flex-col gap-2">
  ...
  <textarea id="createIdeaBody"
   name="body"
                  ...
                  onChange={store.setFormData} rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter a Description..."></textarea>
                  </div>
  <button id="createIdeaBtn" onClick={store.createNote} type="submit" class="text-white bg-indigo-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Submit</button>
